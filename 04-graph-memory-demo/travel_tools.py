...
def remember_fact(subject: str, relation: str, obj: str, tool_context: ToolContext) -> str:
    ...
    Args:
        subject: The entity the fact starts from (e.g. "Sarah Chen").
        relation: The relationship type. One of: WORKS_AT, HAS_STYLE, LOCATED_IN, IN_COUNTRY.
        obj: The entity the fact points to (e.g. "Vista Hotels").
    """
...
def recall_graph(query: str, top_k: int = 3) -> str:
    ...
    questions like "who did I meet connected to boutique hotels in Japan?".
